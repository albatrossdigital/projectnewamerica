...
class MxmConnect {
	...
	*/
	...
	private static $user = 'accounts@albatrossdigital.com';
	private static $key = 'tHP0IqKIcm9yFUVm';
	private static $wsdl ='/api_2.php?wsdl';
	//Host for reporting :)
	private static $default_host = 'http://mail6.messaging-master.com';
	private static $fast_host = array('http://mail6.messaging-master.com', 'http://mail7.messaging-master.com');
	...
	*/
	 ...
	 *
	 * @param tag is a string of less than 40 characters and without spaces or non-ASCII charactersc
